  ...
  ngOnInit() {
   ...
   login(template: any){
    ...
    if (this.signinForm.invalid) {
          this.toastr.error('Please fill valid fields', 'Login Error');
             return;
     }
     ...
     this.ngxService.start()
      ...
      this.toastr.success('Hi! You are LoggedIn..', 'Login');
   ...
   logout(){
    ...
    this.router.navigate(["/"])
    this.toastr.success('You are successfully logout!!!', 'Log Out.');
    this.ngxService.stop();
   }
   ...
   confirmForgotPass(){
    ...
    if (this.forgotPassForm.invalid) {
      this.toastr.error('Please fill valid fields', 'Forgot Password Error');
         return;
 }
    this.ngxService.start()
    this.loginService.forgotPassword(this.forgotPass).subscribe(
      res => {
        this.toastr.success('A link is sent to your registerd email id.', 'Success'); 
        this.ngxService.stop();
        this.forgotPassForm.reset()
        this.modalRefForgot.hide()
      },
      err => { 
        this.toastr.error('You enterend wrong email.', ' Error'); 
        this.ngxService.stop()
      }
    );
   }
